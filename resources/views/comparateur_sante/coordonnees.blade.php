...
<div class="container">
  <div class="row">
    ...
    <form action="{{route('coordonnees_create')}}" method="post">
      ...
      <div class="row box-shadows mb-5">
                      ...
                      <div class="item-cont">
                        <div class="large">
                          ...
                          <select id="civilite" data-no-selected="civilite *" name="civilite" class="form-control" required="required" class="multiple" aria-required="true">
...
<div class="row box-shadows mb-5">
    <div class="col-sm-6">
<label for="text" style="color:blue;">Code postal  :</label> <br/>
    </div>
    <div class="col-sm-6">
        <div class="formBox">
 <input type="text" name="codepostale" class="form-control" placeholder="code postal " required=""> <br/> <br/>
</div>
    </div>
</div>
...
<label for="number" style="color:blue;">Télephone :</label> <br/>
    ...
    <div class="col-sm-6">
        <div class="formBox">
 <input type="number" name="telephone" class="form-control" placeholder="0662870204" required=""> <br/>
