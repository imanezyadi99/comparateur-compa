  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
          <div class="sidebar-brand-icon rotate-n-10">
              <img src="{{URL::asset('images/logos/carrezconseil.png')}}" alt="logo Carrez Conseil" width="40px" height="40px">
             
          </div>
          <div class="sidebar-brand-text " >Carrez Conseil</div>
      </a>
      ...
      <li class="nav-item active">
          <a class="nav-link " href="{{route('compauto')}}" >
      ...
      <li class="nav-item active">
          <a class="nav-link collapsed" href="{{route('compsante')}}">
              <i class="fa fa-user-md" aria-hidden="true"></i>
              <span>Mutuelle Sante</span>
          </a>
      ...
      <footer class="sticky-footer bg-white">
          <div class="container my-auto">
              <div class="copyright text-center my-auto">
                  <span>Tous les droits réservés &copy; <a href="/" > CO Business solution IT 2023 </a></span>
              </div>
          </div>
      </footer>
      <!-- End of Footer -->
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer">
              ...
              <form id="logout-form" action="{{route('logout1')}}"  method="POST">
                  @csrf
                 <button type="submit" class="btn btn-danger" href="{{route('logout1')}}" data-toggle="modal" data-target="#logoutModal" >
                     <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                     Logout
                 </button> 
                </form>
